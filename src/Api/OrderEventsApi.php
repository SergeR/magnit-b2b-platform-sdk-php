...
/**
 * OrderEventsApi Class Doc Comment
 *
 * @category Class
 * @package  SergeR\MagintB2BPlatformSDK
 * @author   OpenAPI Generator team
...
/**
    ...
    /**
     * Operation v1OrdersOrderIdEventPost
     *
    ...
    /**
     * Operation v1OrdersOrderIdEventPostWithHttpInfo
     *
     * События по заказам от Партнера
     *
     * @param  string $orderId Идентификатор заказа в системе Магнита (required)
    ...
    {
        $request = $this->v1OrdersOrderIdEventPostRequest($orderId, $v1OrdersOrderIdEventPostRequest);
            ...
            switch ($e->getCode()) {
                case 400:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\SergeR\MagintB2BPlatformSDK\Type\ErrorResponse',
    ...
    /**
     * Operation v1OrdersOrderIdEventPostAsync
     *
     * События по заказам от Партнера
     *
     * @param  string $orderId Идентификатор заказа в системе Магнита (required)
    ...
    {
        return $this->v1OrdersOrderIdEventPostAsyncWithHttpInfo($orderId, $v1OrdersOrderIdEventPostRequest)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation v1OrdersOrderIdEventPostAsyncWithHttpInfo
     *
     * События по заказам от Партнера
     *
     * @param  string $orderId Идентификатор заказа в системе Магнита (required)
    ...
    public function v1OrdersOrderIdEventPostRequest($orderId, $v1OrdersOrderIdEventPostRequest)
    {
        ...
        if ($orderId === null || (is_array($orderId) && count($orderId) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $orderId when calling v1OrdersOrderIdEventPost'
            );
        }
        ...
        $resourcePath = '/v1/orders/{orderId}/event';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
